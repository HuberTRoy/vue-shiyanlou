    ...
    <div class="comment_dialog">
        <div class="comment_dialog">
            ...
            <div class="send_comment_div"
                 v-if="sign_on"
            >
                <textarea class="comment_text_area" id="comment_text_area" 
                          :placeholder="placeholder" 
                          v-model="comment_content">
                </textarea>
                <div class="comment_operation_div">
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            cancel: 'comments/change_reply_id',
            init_text: 'comments/change_text_placeholder'
        }),
        show_login: function () {
