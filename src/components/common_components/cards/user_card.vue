        ...
        <div class="user_operation_card">
            ...
            <div class="user_operation">
                <!--
                    ...
                    flex wrap 50% 50%
                 -->
                 <router-link tag="a" :to="{name: 'user', params: {id: data.id}}" class="user_operation_button">
                     我的主页
                 </router-link>
                 <router-link tag="a" :to="{ name: 'userProfile' }" class="user_operation_button">
                     个人设置
                 </router-link>
